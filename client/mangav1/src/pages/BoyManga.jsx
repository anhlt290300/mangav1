...
const BoyManga = () => {
  ...
  const [dataBoyManga, setDataBoyManga] = useState(null);
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        let { topmangas, boymangas, pages } = res.data;
        let { page, href } = pages;
        setDataBoyManga(boymangas);
  ...
  if (!dataBoyManga) return <Loading />;
};

export default BoyManga;
